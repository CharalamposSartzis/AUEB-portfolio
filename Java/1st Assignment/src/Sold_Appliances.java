...
public class Sold_Appliances extends Electrical_Appliance{
	...
	public String toString(){
		return("Sale Index: "+getSoldIndex()+"| Sold Appliance: ["+getSoldApp()+"]"+"| Orderer Name: "+getBuyerName()+"| Orderer Phone: "+getBuyerPhone()+"| Date of sale: "+getSoldDate()+"| Final cost: "+Calculate_Discount.calculateCost(soldAppliance)+" $");
	}
}